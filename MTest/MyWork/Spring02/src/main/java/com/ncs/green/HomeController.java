...
// ** Logger : 현재 위치상태를 보여줘서 에러 위치를 잡게 해주는 코드
// => Log4J의 핵심 구성 요소로 6개의 로그 레벨을 가지고 있으며,
//    출력하고자 하는 로그 메시지를 Appender (log4j.xml 참고)에게 전달
...
//		logger.info("test 3) name = {}, age = {}", name, age);
