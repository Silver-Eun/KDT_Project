...
<c:out value="Hello JSTL, 안녕 JTSL" />
...
* Test1) 정의 순서 : set -> page_setAttribute
\${name} = ${name} : pageScope 우선 적용

* Test2) set의 name 등 재정의
