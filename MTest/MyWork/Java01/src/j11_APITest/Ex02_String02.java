...
public class Ex02_String02 {
	...
	public static void main(String[] args) {
		...
		// 없으면 -1(음수) , indexOf("e",fromIndex) 특정 index 이후부터 적용가능, 여러개면 첫번째것 return
		...
		// ** 실습
		// 1) 아래 url에서 화일명만 추출해서 출력하세요~~ 
		// 2) 아래 url에서 화일의 확장자만 추출해서 출력하세요~~ 
		// 3) 위의 city, country에서 "Korea"만 추출해서 출력해보세요
