...
public class Ex03_argumentTest {
	...
	public static void main(String[] args) {
		// 1) 일반변수 사용
		// => 비교 가능한 Type이 없어서 논리적오류를 예방할 수 없음
		whoAreU(DOG);
		whoAreU(MAN);
		// 2) enum 사용
		// => 컴파일타임에 검증 가능
		...
		// => 컴파일오류로 비교 불가 (비교 대상이 interface일 때만 컴파일오류 없이 비교 가능)  
	...
	static void whoAreU(int p) {
		switch (p) {
		case 0 : System.out.println("MAN입니다"); break;
		case 1 : System.out.println("WOMAN입니다"); break;
		case 2 : System.out.println("CHILD입니다"); break;
		} //switch
	}
	...
	static void whoAreUe(Person p) {
		...
		case WOMAN : System.out.println("WOMAN입니다"); break;
		case CHILD : System.out.println("CHILD입니다"); break;
		} //switch
	}
