...
public class Ex08_Operator01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("++a = " + (++a)); // 11, 증가 후 출력, a = 11
		System.out.println("b++ = " + (b++)); // 10, 출력 후 증가, b = 11
		System.out.println("--a = " + (--a)); // 10, 감소 후 출력, a = 10
		System.out.println("b-- = " + (b--)); // 11, 출력 후 감소, b = 10
