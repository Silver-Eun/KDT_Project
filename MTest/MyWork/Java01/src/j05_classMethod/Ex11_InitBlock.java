...
//    그러므로 인스턴스 초기화 블럭은 인스턴스 생성시마다 실행됨 

public class Ex11_InitBlock {

	static int[] arr = new int[10];
	static int count = 100; // 선언과 동시에 초기화
	String color;
	...
	public static void main(String[] args) {
		...
		Ex11_InitBlock ex21 = new Ex11_InitBlock();		
		System.out.println("main ex21 color = " + ex21.color);
		System.out.println("main ex21 num = " + ex21.num);
	}
