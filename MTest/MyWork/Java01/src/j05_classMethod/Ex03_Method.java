...
public class Ex03_Method {
	...
	// 1) 매개변수, return 값 없음
	public void juiceCafe1() { // 메소드 헤더 {...실행문...} 메소드 바디
		System.out.println("어떤 주스를 원하시나요 ");
	}
	
	// ** 메소드명
	// => 일반적인 식별자 규칙 준수
	// => 소문자로 시작
	// => 동일한 이름의 메소드명 허용 ( 매개변수의 갯수, 타입이 다른 경우 )
	...
	public static void main(String[] args) {
		...
		// ex03.juiceCafe2(2, "수박"); 호출시 반드시 인자 일치
		...
		System.out.println("main 바로 생성 return값 => " + ex03.carTest(new Car(), 999));		
	} // main
