...
import j05_classMethod.Ex01_CarTest;
import static j07_classExtends.Animal.color;

import java.util.Arrays;

// ** static, final과 상속, main 메서드 정리
...
//    그러므로 public static void여야만 함
//    메소드 main, 인자값 중 하나라도 변경되면 실행되지 않음
//    -> Error: Main method not found in class j07_classExtends.Ex04_Father.....

// => 매개변수는 필요시 사용 가능(사용 Test)
// => main 메서드 오버로딩 Test
...
public class Ex04_Father {
	...
	// 모든 자식 인스턴스가 공유하는 값은 static으로 정의
	// static 적용 전/후 Child 인스턴스 생성시 비교
	static String name;
	private int money;
	...
	// 메소드에 static
	// => static 메소드에서는 this, super 사용 금지
//	public void sbank(int money) {
//		this.money += money;
//		System.out.printf("Father bank total_money = %d, today_money = %d\n",
//				this.money, money);
//	}
	...
	public static void main(String[] args) {
		...
		// main의 매개변수 args 사용
		// 실행시 전달됨 : apple banana peach 111 222(스페이스로 구별)
		...
		Ex04_Father f2 = new Ex04_Father("홍길동", 1000);
		f2.bank(-10000);
		f2.info();
