...
//    -> Runnable을 구현한 MyThread02 생성시 이용됨
...
public class Ex01_threadBasic {
	...
	public static void main(String[] args) {
		...
		MyThread01 t02 = new MyThread01(); // 다형성 적용 가능
		...
		// => 비교 : run() 호출
		// => multi thread 는 실행되지 않고 main이 일반 메서드 호출 & 실행.
		// thread 적용없이 순서대로 실행
		// t01.run();
		// t02.run();

		// Test2) Runnable
		// => 생성 1단계 : 일반클래스 (필요한 Thread 메소드 접근불가)
