...
public class Ex02_SleepRun {
	...
	public static void main(String[] args) {
		/*
		 * Test1) Rabbit01 : 토끼_Thread 출발 준비 // => 우선순위는 동일하고 sleepTime 은 서로 다름 Rabbit01 red
		 * = new Rabbit01("Red") ; Rabbit01 blue = new Rabbit01("Blue") ; Rabbit01 green
		 * = new Rabbit01("Green") ;
		 */
...
//	               } //catch
		...
		/*
		 * main 메서드도 main 쓰레드 => 다른 쓰레드와 마찬가지로 자신만의 실행 흐름을 이어감 // main 메서드가 종료되어도 남은
		 * 쓰레드는 실행됨 // => 모든 쓰레드가 종료되어야 프로그램은 종료됨.
		 */
