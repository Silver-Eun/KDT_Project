...
class OuterClass{
   ...
   static class Inner {
      ...
      //    -> Outer의 non_static 멤버 접근시 인스터스가 필요함
      ...
      // => ver01: non_static Inner인 경우
      //    Outer의 static, non_static, private 등 모든 맴버에 접근 가능
