...
public class Ex08_MapStudent {
	...
	public static void main(String[] args) {
		...
		// 2. 초기화
		sm.put("A001", new Student("A001", "Kim", 90, 80));
		sm.put("A002", new Student("A002", "Lee", 80, 70));
		sm.put("A003", new Student("A003", "Choi", 70, 60));
		sm.put("B001", new Student("B001", "Park", 50, 90));
		sm.put("B002", new Student("B002", "Eun", 100, 100));
