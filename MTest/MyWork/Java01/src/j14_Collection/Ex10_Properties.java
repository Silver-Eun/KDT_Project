...
//    그래서 간단한 입출력은 Properties를 활용하면 몇 줄의 코드로 쉽게 해결할 수 있음
...
public class Ex10_Properties {
	...
	public static void main(String[] args) {
		...
		// pp.setProperty(111, "StudentDelete.java"); // -> String, String만 허용(컴파일 오류)
		pp.put("delete", "StudentDelete.java");
		// pp.put(111, 1234567);
		// -> String, String만 허용돼야 하는데 JDK11에서는 허용됨
		System.out.println("Properties Test");
		System.out.println(pp);
		
		// 2. 순차처리
		// => Enumeration 이용
		// => propertyNames(): Properties의 Key값들만 return
