...
// ** Test1) : spa, spb 생성후 @Autowired만 한 경우
...
// ** Test3) @Qualifier("spq") : 명시적으로 요청했지만 없는 경우
// => 정확하게 id가 일치하는 객체를 찾으므로 오류 발생

// => xml, @ 병행 가능
//	  Speaker의 생성은 xml에 <bean ..> 등록후 Test
...
class LgTVsi implements TV {
	...
	// => 해당 Type의 인스턴스로 찾지 못하면 null return
	@Qualifier("spb")
