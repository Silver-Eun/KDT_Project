...
public class TVUser02 {
	...
	public static void main(String[] args) {
		...
		//    xml문을 "src/main/resources"에 두면 패키지는 생략 가능 
		...
		// => 스프링 프레임워크의 모든 작업은 싱글톤을 기본으로 함
		// => 싱글톤 (한개의 인스턴스만 허용 하는것) 적용 Test
		// => 설정화일의 scope 속성에 "prototype"_ss / "singleton"_lg (default는 싱글톤)
		// => 생성자 실행 횟수와 아래의 주소값 확인해보기
		//    SsTVi 2개, LgTVi 2개씩 인스턴스 작성 후 확인 	
		...
		System.out.println("** tvl_lg => "+tvl2); // lg : singleton (같은주소)
		sc.close();
