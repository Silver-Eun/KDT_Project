...
//            ( 공통 관심사항이 적용될 수 있는 지점, ex:메소드 호출시, 객체생성시 등 )
...
public class MyAspect {
	...
	public void myAfter_returning() {
		System.out.println("200 OK : 회원가입, 게시판 글 등록이 잘됩니다.");
	}
	   
	// ** After_throwing: 핵심적 관심사항 비정상종료
	public void myAfter_throwing() {
		System.out.println("밤 새워 수정합니다 => 예외발생으로 핵심 관심사항 비정상종료");
	}
	
	// ** After: 정상/비정상 관계없이 무조건 시행
	public void myAfter() {
		System.out.println("** finally : 무조건 제출한다 => 무조건 종료");
	}
}
