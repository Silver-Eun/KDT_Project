...
function reducer(currentState, action) {
  ...
  if (action.type === "PLUS") { newState.number++; newState.number2++; }
  return newState;
}
...
function Left3() {
  ...
  return (
    <div>
      <h1>
        Left3 number={number}, number2={number2}
      </h1>
    </div>
  );
} //Left3
...
function Right3() {
  ...
  return (
    <div>
      <h1>Right3</h1>
      <input type="button" value='Increase' onClick={() => dispatch({ type: 'PLUS' })} />
    </div>
  );
} //Right3
